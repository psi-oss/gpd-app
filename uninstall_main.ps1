...
# This is the main uninstaller. Users typing
#   irm https://download.gpd.psi.inc/uninstall.ps1 | iex
# hit a tiny ASCII bootstrap (uninstall.ps1) that downloads THIS file
# with explicit UTF-8 decoding and runs it as a scriptblock - which is
# what makes [CmdletBinding()] + param() at top legal under iex.
#
