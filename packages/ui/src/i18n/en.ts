export const dict: Record<string, string> = {
  "ui.sessionReview.title": "Conversation changes",
  "ui.sessionReview.title.git": "All tracked changes",
  "ui.sessionReview.title.branch": "Changes vs. base version",
  ...
  "ui.sessionReview.largeDiff.title": "Too many changes to show at once",
  "ui.sessionReview.largeDiff.meta": "Limit: {{limit}} changed lines. Current: {{current}} changed lines.",
  "ui.sessionReview.largeDiff.renderAnyway": "Show anyway",
  ...
  "ui.fileMedia.state.error": "Couldn't load the {{kind}}.",
  "ui.fileMedia.state.unavailable": "{{kind}} preview unavailable.",
  "ui.fileMedia.binary.title": "Non-text file",
  "ui.fileMedia.binary.description.path": "{{path}} can't be shown as text.",
  "ui.fileMedia.binary.description.default": "Non-text content",
  ...
  "ui.sessionTurn.status.searchingCodebase": "Searching your project",
  ...
  "ui.sessionTurn.elapsed.tooltip": "Total wall time for this response",
  ...
  "ui.messagePart.compaction": "Conversation summarized",
  ...
  "ui.tool.read": "Reading file",
  "ui.tool.loaded": "Loaded",
  "ui.tool.list": "Listing files",
  "ui.tool.glob": "Finding files",
  "ui.tool.grep": "Searching inside files",
  "ui.tool.task": "Sub-task",
  "ui.tool.webfetch": "Fetching page",
  "ui.tool.websearch": "Searching the web",
  "ui.tool.codesearch": "Searching code online",
  "ui.tool.shell": "Running command",
  "ui.tool.patch": "Applying changes",
  "ui.tool.todos": "To-dos",
  "ui.tool.todos.read": "Read to-dos",
  "ui.tool.questions": "Questions",
  "ui.tool.agent": "{{type}} assistant",
  ...
  "ui.message.forkMessage": "Branch to new conversation",
