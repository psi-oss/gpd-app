        ...
        if let Some(provider_obj) = provider.as_object_mut() {
            ...
            provider_obj.insert("gpd".to_string(), serde_json::json!({
                ...
                "models": {
                    ...
                    "gpt-5.5-pro": { "name": "GPT 5.5 Pro", "tool_call": true, "reasoning": true, "attachment": true, "temperature": true, "modalities": { "input": ["text", "image", "pdf"], "output": ["text"] }, "limit": { "context": 1050000, "output": 128000 } },
...
mod tests {
    ...
    fn build_config_json_has_all_16_models() {
        ...
        assert_eq!(models.len(), 16, "expected 16 models, got {}", models.len());
