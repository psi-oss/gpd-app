...
export const SettingsGeneral: Component = () => {
  ...
  // AccountSection moved to its own SettingsApiKey pane (settings-api-key.tsx)
  // as part of the v1.0.3 dedicated API Key settings tab. The General tab now
  // hosts only app-level prefs.
