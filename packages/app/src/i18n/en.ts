export const dict = {
  ...
  "settings.profile.name.placeholder": "Alex Maloney-Mendelsohn",
  "settings.profile.affiliations.label": "Affiliations",
  "settings.profile.affiliations.placeholder": "Physical Superintelligence PBC",
  ...
  "settings.profile.email.placeholder": "alex@example.edu",
